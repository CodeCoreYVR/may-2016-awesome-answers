class Ability
  ...
  def initialize(user)
    # CanCanCan assumes that you have a method called `current_user` which
    # is available in the application controller. You don't have to explicitly
    # create an Ability Object, this will be done automatically.
